  ...
  <div class="ProfessionalSetup">
    ...
    <SystemSelect :list="test" v-model="multiple">
      <div slot="button" class="button">
        ...
        <button class="daoru">批量导入</button>
    ...
    <Popup v-model="add" position="center" :title="title">
      <div class="formCell" v-if="title === '添加三级学科'">
        <p class="form-label">选择二级</p>
        <JInput type="select"></JInput>
      </div>
      <div class="formCell" v-if="title === '添加三级学科'">
        <p class="form-label">添加三级</p>
        <JInput></JInput>
      </div>
      <div class="formCell" v-if="title === '添加三级学科'">
      ...
      <div class="formCell" v-if="title === '添加二级学科'">
        <p class="form-label">添加二级</p>
        <JInput></JInput>
      </div>
