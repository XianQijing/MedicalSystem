  ...
  <div class="LevelFour">
    ...
    <SystemSelect :list="test" v-model="multiple">
      <div slot="button" class="button">
        <button class="edit" @click="addType('修改类别')">修改</button>
        <button class="shanchu">删除</button>
      </div>
    </SystemSelect>
    <div class="edit-button" @click="addType('添加大类')"></div>
    <Popup v-model="add" position="center" :title="title">
      <div class="formCell">
        <p class="form-label">一级科目</p>
        <JInput/>
      </div>
      <div class="formCell">
        <p class="form-label">二级科目</p>
        <JInput/>
      </div>
      <div class="formCell">
        <p class="form-label">三级科目</p>
        <JInput/>
      </div>
      <div class="formCell">
