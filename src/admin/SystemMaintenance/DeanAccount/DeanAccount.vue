  ...
  <div class="DeanAccount">
    ...
    <checkall v-model="multiple">
      <card
        ...
        <span>项目类别</span>
        <span>项目类别</span>
        <span class="border-1pxTop" style="margin-bottom: 0">项目类别</span>
        <span>项目类别</span>
        <div style="text-align:center">
        <JButton type="primary" round @click="jump">修改</JButton>
        </div>
      </card>
      <JButton slot="button" type="success">启用</JButton>
      <JButton slot="button" type="warning">停用</JButton>
      <JButton slot="button" type="danger">删除</JButton>
    </checkall>
  </div>
</template>
