    ...
    <div class="content">
      ...
      <Collaspe name="本次审核信息">
        ...
        <div class="formCell">
          ...
          <p class="form-desc blue">
            <IconSvg iconClass="icon-icon_preview"/>
        ...
        <div class="formCell">
          <p class="form-label">差旅费明细：</p>
          <p class="form-desc">明细占位</p>
        </div>
        <div class="formCell">
        ...
        <div class="formCell">
          <p class="form-label">详细说明：</p>
          <p class="form-desc">说明占位说明占位说明占位说明占位</p>
        </div>
      </Collaspe>
    </div>
