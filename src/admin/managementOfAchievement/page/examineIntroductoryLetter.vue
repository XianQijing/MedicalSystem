// 介绍信审核--介绍信审核
<template>
  <div class="examineIntroductoryLetter">
    <CTitle>基本信息</CTitle>
    <div class="form">
      <div class="formCell">
      ...
      <div class="formCell">
        <p class="form-label">作者姓名:</p>
        <p class="form-msg">测试课题1</p>
      </div>
      <div class="formCell">
        <p class="form-label">作者属性:</p>
        <p class="form-msg">关键词1、关键词2</p>
      </div>
      <div class="formCell">
        <p class="form-label">论文题目:</p>
        <p class="form-msg">基础研究</p>
      </div>
      <div class="formCell">
        <p class="form-label">项目基金类别:</p>
        <p class="form-msg">眼科</p>
      </div>
      <div class="formCell">
        <p class="form-label">文件:</p>
    ...
    <CTitle>科室审核意见</CTitle>
    <div class="form">
      <div class="formCell">
        <p class="form-label">资料是否真实:</p>
        <p class="form-msg">否</p>
      </div>
      <div class="formCell">
        <p class="form-label">有无抄袭之嫌:</p>
        <p class="form-msg">否</p>
      </div>
      <div class="formCell">
        <p class="form-label">是否一稿多投:</p>
        <p class="form-msg">否</p>
      </div>
      <div class="formCell">
        <p class="form-label">存在其他问题:</p>
        <p class="form-msg">否</p>
      </div>
    </div>
    <div class="btn">
