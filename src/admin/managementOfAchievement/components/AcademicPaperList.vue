// 学术论文列表
<template>
  <div class="AcademicPaperList">
    <CTitle :screen="true" :textList="textList">学术论文列表</CTitle>
...
export default {
  name: 'AcademicPaperList',
  data () {
    return {
      textList: ['时间范围', '作者属性', '论文类别', '论文属性', '经费来源', '所属学科'],
      multiple: [],
      messageList: [
        {
