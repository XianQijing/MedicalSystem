// 人才学术水平
<template>
  <div class="BasicDataOfTalents">
    <CTitle>所在单位</CTitle>
    <div class="formCell">
      <p class="form-label">医院等级:</p>
      <p class="form-msg">预览</p>
    </div>
    <CTitle>所在学科</CTitle>
    <div class="formCell">
      <p class="form-label">学科等级:</p>
      <p class="form-msg">测试课题1</p>
    </div>
    <CTitle>学术任职</CTitle>
    <Collaspe name="任职情况">
      <div class="formCell">
        <p class="form-label">任职名称:</p>
        <p class="form-msg">测试课题1</p>
      </div>
      <div class="formCell">
    ...
    <Collaspe name="获得荣誉">
      <div class="formCell">
        <p class="form-label">荣誉名称:</p>
        <p class="form-msg">测试课题1</p>
      </div>
      <div class="formCell">
        <p class="form-label">颁证单位:</p>
        <p class="form-msg">测试课题1</p>
      </div>
      <div class="formCell">
