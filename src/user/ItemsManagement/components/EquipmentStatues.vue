// 仪器设备--状态查询及打印
<template>
  <div class="EquipmentStatues">
    <CTitle :screen="true" :textList="textList">状态列表</CTitle>
...
export default {
  name: 'EquipmentStatues',
  data () {
    return {
      textList: ['时间范围', '申报类别', '项目类别', '项目计划', '审核状态', '打印状态'],
      messageList: [
        {
  ...
  methods: {
    jump () {
      this.$router.push({name: 'EquipmentStatuesDetail'})
    }
  }
}
</script>
