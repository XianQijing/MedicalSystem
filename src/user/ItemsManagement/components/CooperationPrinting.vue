...
export default {
  name: 'CooperationPrinting',
  data () {
    return {
      textList: ['时间范围', '申报类别', '项目类别', '审核状态', '打印状态'],
      messageList: [
        {
  ...
  methods: {
    jump () {
      this.$router.push({name: 'CooperationPritingDetail'})
    }
  }
}
</script>
