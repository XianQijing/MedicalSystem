...
<template>
  <div class="ExperimentalPriting">
    ...
    <card
      ...
      <span>课题名称</span>
      <span>支付费用：121.00</span>
      <span class="resTime">使用时间：2018.09.01 12:00</span>
...
export default {
  ...
  methods: {
    jump () {
      this.$router.push({name: 'ExperimentalPritingDetail'})
    }
  }
}
</script>
