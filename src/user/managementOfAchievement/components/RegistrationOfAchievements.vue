  ...
  <div class="RegistrationOfAchievements">
    ...
    <div class="wrapper">
      ...
      <div class="item-wrapper border-1px">
        <p class="item-title">颁证机关：</p>
        <JInput placeholder="下拉选择"/>
      </div>
      <div class="item-wrapper border-1px">
        <p class="item-title">成果获得日期：</p>
        <JInput placeholder="下拉选择" type="select"/>
      </div>
      <div class="item-wrapper border-1px">
        <p class="item-title">颁证日期：</p>
        <JInput placeholder="下拉选择" type="select"/>
      </div>
      <div class="item-wrapper border-1px">
        <p class="item-title">登记号：</p>
        <JInput placeholder="下拉选择"/>
      </div>
      <div class="item-wrapper border-1px">
        <p class="item-title a">上传登记证书：</p>
        <div class="upload">
...
<script>
export default {
  namw: 'RegistrationOfAchievements',
  data () {
    return {
