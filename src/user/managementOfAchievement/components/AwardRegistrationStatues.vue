// 成果申报状态查询
<template>
  <div class="AwardRegistrationStatues">
    <CTitle :screen="true" :textList="textList">成果列表</CTitle>
      ...
      <card
        ...
        <div class="formCell">
          <span>奖励名称:</span>
          <span>奖励类别:sfsdf</span>
        </div>
        <span>奖励等级:</span>
        <span class="resTime">审核日期：2018.04.22</span>
...
export default {
  ...
  methods: {
    jump () {
      this.$router.push({name: 'AwardRegistrationDetail'})
    }
  }
}
</script>
...
.AwardRegistrationStatues >>> .comTitle
  margin 0
