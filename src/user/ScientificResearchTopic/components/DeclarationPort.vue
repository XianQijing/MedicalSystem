...
<template>
  <div class="DeclarationPort">
    ...
    <card
      ...
      <span>项目类别</span>
      <div class="formCell">
        <span class="resTime">起始时间：2017.08.12</span>
        <span class="resTime">截止时间：2017.08.12</span>
      </div>
      <div style="text-align:center">
        <button slot="button" class="abtn" @click="jump">标书模版预览</button>
      </div>
    </card>
  </div>
</template>
